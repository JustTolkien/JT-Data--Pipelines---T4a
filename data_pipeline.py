...
users_usa = transform_users(users_usa, country_code='USA',
                           ...
                           currency='USD')
logins_usa = load_login_data('data/FR-User-LoginTS.csv', 'US/Eastern')
validate_user_visits(users_usa, logins_usa)
# users_usa


get_ipython().system('sqlite3 customers.db < create_database.sql')
...
# !jupyter nbconvert --no-prompt --to script explorer_T3.ipynb
